  ...
  return (
   ...
   {error && <FeedbackModal success={false} error={true} closeModal={closeModal}  message={message}/>}
    <div className='w-screen h-screen bg-sub-white flex justify-center items-center'>
        <div className='bg-white rounded-lg w-11/12 h-auto lg:w-2/6 xl:h-auto 2xl:w-1/4 2xl:h-auto px-5 py-7 lg:py-10 lg:px-7'>
            <div className='flex flex-row justify-between'>
                <h2 className='text-xl lg:text-3xl font-meduim'>Checkout</h2>
                <div className='flex justify between'>
                    <p className='mt-1 lg:mt-2 text-sm mr-1'>Powered by</p>
            ...
            <form onSubmit={handleSubmit}>
                <div className='mt-5'>
                    <input type="text" className='border border-sub-dark py-3 lg:py-4 rounded my-2 w-full px-2' placeholder='Full Name' onChange={(e) => setFullName(e.target.value)}/>
                    <input type="text" className='border border-sub-dark py-3 lg:py-4 rounded my-2 w-full px-2' placeholder='Email' onChange={(e) => setEmail(e.target.value)}/>
                    <input type="text" className='border border-sub-dark py-3 lg:py-4 rounded my-2 w-full px-2' placeholder='Amount' onChange={(e) => setAmount(e.target.value)}/>
                    <CardElement className='border border-sub-dark rounded py-4 lg:py-5 px-2 my-2'/>
                </div>
